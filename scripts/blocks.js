...
const energyBlocks = [
    ...
    },
    {
        ...
        category: 'energy',
        level: 0, maxLevel: 30, unlocked: false,
        output_per_level: 130,
        input_resource: 'coal',
        input_per_level: 1.5,
        fluid_input_resource: 'water',
        fluid_input_rate: 10,
    ...
    },
    {
        ...
        category: 'energy',
        level: 0, maxLevel: 10, unlocked: false,
        output_per_level: 1400,
        input_resource: 'pyratite',
        input_per_level: 0.5,
        fluid_input_resource: 'cryo',
        fluid_input_rate: 20,
        cost: { copper: 70, lead: 50, titanium: 50, silicio: 50 },
        cost_multiplier: 1.7,
    ...
    },
    {
        ...
        description: 'Fuses Surge Alloy and Thorium for 2550 E/s per level.',
        category: 'energy',
