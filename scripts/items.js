...
const resources = [
    { id: 'copper', name: 'Copper', sprite: 'assets/sprites/item-copper.png', unlocked: true, clickPower: 5, tier: 0 },
    { id: 'lead', name: 'Lead', sprite: 'assets/sprites/item-lead.png', unlocked: false, clickPower: 1, unlockReq: { upgradeId: 'copper-drill', minLevel: 10 }, tier: 0 },
    { id: 'coal', name: 'Coal', sprite: 'assets/sprites/item-coal.png', unlocked: false, clickPower: 1, unlockReq: { upgradeId: 'lead-drill', minLevel: 10 }, tier: 0 },
    { id: 'sand', name: 'Sand', sprite: 'assets/sprites/item-sand.png', unlocked: false, clickPower: 1, unlockReq: { upgradeId: 'coal-drill', minLevel: 10 }, tier: 0 },
    ...
    { id: 'phase-fabric', name: 'Phase Fabric', sprite: 'assets/sprites/item-phase-fabric.png', unlocked: false, clickPower: 1, unlockReq: { blockId: 'phase-weaver', minLevel: 1 }, tier: 3 },
    { id: 'surge-alloy', name: 'Surge Alloy', sprite: 'assets/sprites/item-surge-alloy.png', unlocked: false, clickPower: 1, unlockReq: { blockId: 'surge-smelter', minLevel: 1 }, tier: 3 },
    { id: 'spore-pod', name: 'Spore Pod', sprite: 'assets/sprites/item-spore-pod.png', unlocked: false, clickPower: 1, unlockReq: { blockId: 'spore-press', minLevel: 1 }, tier: 'L' },
    { id: 'pyratite', name: 'Pyratite', sprite: 'assets/sprites/item-pyratite.png', unlocked: false, clickPower: 1, unlockReq: { blockId: 'pyratite-mixer', minLevel: 1 }, tier: 'L' },
    { id: 'blast-compound', name: 'Blast Compound', sprite: 'assets/sprites/item-blast-compound.png', unlocked: false, clickPower: 1, unlockReq: { blockId: 'blast-mixer', minLevel: 1 }, tier: 'L' },
];
